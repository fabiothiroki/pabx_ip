...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_userprofile', (
            ...
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('ramal', self.gf('django.db.models.fields.PositiveIntegerField')(unique=True)),
