...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.passw'
        db.add_column('accounts_userprofile', 'passw', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.passw'
        db.delete_column('accounts_userprofile', 'passw')
